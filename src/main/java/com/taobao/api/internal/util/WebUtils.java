...
public abstract class WebUtils {
    ...
    static {
           ...
           new javax.net.ssl.HostnameVerifier(){
               ...
               public boolean verify(String hostname,
                   ...
                   if (hostname.equals("oauth.tbsandbox.com")) {
                       return true;
                   }
                   return false;
               }
    ...
    public static String doPost(String url, Map<String, String> params,int connectTimeout,int readTimeout,boolean ssl) throws IOException {
		return doPost(url, params, DEFAULT_CHARSET,connectTimeout,readTimeout,ssl);
	}
	 ...
	 * @throws IOException
	 */
	public static String doPost(String url, Map<String, String> params, String charset,int connectTimeout,int readTimeout,boolean ssl)
			throws IOException {
		String ctype = "application/x-www-form-urlencoded;charset=" + charset;
		String query = buildQuery(params, charset);
		byte[] content={};
		...
		return doPost(url, ctype, content, connectTimeout, readTimeout,ssl);
	}
	 ...
	 * @throws IOException
	 */
	public static String doPost(String url, String ctype, byte[] content,int connectTimeout,int readTimeout,boolean ssl) throws IOException {
		HttpURLConnection conn = null;
		OutputStream out = null;
		String rsp = null;
		try {
			try{
				conn = getSSLConnection(new URL(url), METHOD_POST, ctype);
				conn.setConnectTimeout(connectTimeout);
				conn.setReadTimeout(readTimeout);
			}catch(IOException e){
				Map<String, String> map=getParamsFromUrl(url);
    ...
    private static HttpURLConnection getSSLConnection(URL url, String method, String ctype)
