...
import com.pupuly.service.MailEngine;
import com.pupuly.service.RoleManager;
import com.pupuly.service.UserManager;
...
public class BaseAction extends ActionSupport {
    ...
    protected static String url = "";//沙箱环境调用地址
     //正式环境需要设置为:http://gw.api.taobao.com/router/rest
    protected static String APP_KEY = "12007234";
    protected static String APP_SECRET = "sandbox37f9acf1bd98c87ca326eacd8";
    protected final static String REDIRECT_URL="http://127.0.0.1:8080";
    protected final static String TOKEN_URL = "https://oauth.tbsandbox.com/token";
    ...
    public String getTopSession(){
        return (String)getRequest().getSession().getAttribute("top_session");
    }
